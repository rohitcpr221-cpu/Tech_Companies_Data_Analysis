...
I worked on this project to explore how data analysis can be used to understand the performance of a tech company. The idea was to take a raw dataset and turn it into meaningful insights about users, revenue, and overall trends.
...
With this analysis, I tried to answer questions like:

- How is user growth changing over time?
- What trends can we see in revenue?
...
I started by cleaning the dataset:
...
Then I explored the data to understand it better:

- Checked basic statistics
- Looked at distributions and trends
- Explored relationships between variables

Analysis & Insights

Some of the key things I analyzed:
...
- Thinking analytically about business problems
